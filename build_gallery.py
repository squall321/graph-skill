...
MAP = [
    ...
    ("risk-matrix", "riskmatrix", "T2 정형C ★신규", "리스크 매트릭스 — P·I zone·완화 전후"),
    ("friction-wear-curve", "frictionwear", "T2 정형C ★신규", "마찰-거리 — 정상상태·런인"),
    ("fan-pump-operating-point", "fanpump", "T2 정형C ★신규", "팬/펌프 운전점 — 성능×시스템 교점"),
    ("tq-pinch-diagram", "tqpinch", "T2 정형C ★신규", "T-Q 핀치 — 합성곡선·ΔTmin"),
    ("jr-curve", "jrcurve", "T2 정형C ★신규", "J-R 곡선 — 블런팅·멱법칙"),
    ("load-transient-response", "loadtransient", "T2 정형C ★신규", "부하 과도 — 2패널·오버슈트/회복"),
    ("mott-schottky-cv", "mottschottky", "T2 정형C ★신규", "Mott-Schottky — N_D·V_fb"),
    ("compressor-map", "compmap", "T2 정형C ★신규", "압축기 맵 — 속도선·서지·운전점"),
    ("harmonic-spur-table", "harmonspur", "T2 정형C ★신규", "고조파/스퓨리어스 — n×f0 자동검출"),
    ("eye-mask-compliance", "eyemask", "엔진오버레이 ★신규", "아이 마스크 — 폴리곤 히트카운트 판정"),
    ("efficiency-map", "effmap", "엔진오버레이 ★신규", "효율 맵 — 등효율+외곽선·동작점"),
    ...
    ("candlestick-ohlc", "candlestick", "T1 비즈니스 ★신규", "기간별 OHLC 캔들 (상승=속빈/하락=채움, 윅=고저)"),
    ("slopegraph", "slopegraph", "T1 비즈니스 ★신규", "전/후 평행축 연결선 + 끝점 라벨 (순위 역전, Tufte)"),
    ("dumbbell-plot", "dumbbell", "T1 비즈니스 ★신규", "범주별 두 값 격차 (점-연결선, 가로 정렬)"),
    ("diverging-likert-bar", "diverging_likert", "T1 비즈니스 ★신규", "Likert 발산 누적막대 (중립 기준 좌우, 우호/비우호)"),
    ("funnel-conversion-chart", "funnel", "T1 비즈니스 ★신규", "단계별 전환 퍼널 (중앙 정렬·테이퍼 + 전환%)"),
